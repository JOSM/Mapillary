...
public class MapillaryData {
    ...
    /**
     * Changeset Listeners of the class.
     */
    private final List<MapillaryChangesetListener> changesetListeners = new CopyOnWriteArrayList<>();
    /**
    ...
    /**
     * Adds a new changeset listener.
     *
     * @param lis MapillaryChangesetListener to be added.
     */
    public final void addChangesetListener(MapillaryChangesetListener lis) {
        this.changesetListeners.add(lis);
    }
    ...
    private void fireChangesetChanged(MapillaryAbstractImage image) {
        if (this.changesetListeners.isEmpty())
            return;
        for (MapillaryChangesetListener lis : this.changesetListeners) {
            if (lis != null)
